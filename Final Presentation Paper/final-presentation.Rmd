...
<h3> Results </h3>
<br>
![Neurons Versus Mass (for all Brain Areas)](../plot/hh-paper-plots_files/figure-html/Brain_area_NeuronsVsMass-1.png)
...
![Neurons Versus Mass for different brain areas (with highlighted outliers)](../plot/plot.png)
<br>
